...
function attemptToGuessSearchTerm(typedSearchTerm) {
    ...
    parameters = {
        "action": "query",
        "prop": "images|info|pageimages|pageterms",
        "format": "json",
        "pilimit": 1,
        "wbptterms": "description",
        "generator": "allpages",
...
function displayErrorMessage(searchedText) {
    $("#cy").append("Your search did not yield \"" + searchedText + "\" did not generate any results, but we worked hard to guess what you meant. Check out the suggestions below.");
}
